...
# Set page configuration with logo and theme
st.set_page_config(
    page_title="Starticulation Articulation Assessment",
    page_icon="logo.png",
    layout="wide"
)
...
col2.markdown(
    """<h1 style='margin-bottom:0; color:#333333;'>Starticulation</h1>
    <p style='margin-top:0; color:#555555; font-size:20px;'>Articulation Assessment</p>""",
...
if child_name and age_months:
    ...
    if process_records:
        ...
        output += "<strong>Typical but Delayed Processes</strong><ul>" + ''.join(f"<li>{x}</li>").
format(x) for x in set(typical)) + "</ul>"
